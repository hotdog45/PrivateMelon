...
+ (void)show:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
    ...
    hud.bezelView.backgroundColor =[UIColor colorWithRed:0.173 green:0.369 blue:0.329 alpha:1.000];
...
+ (void)showHudWithView:(UIView *)view{
   MBProgressHUD *HUD = [[MBProgressHUD alloc] initWithView:view];
    ...
    UIImage *image = [self sd_animatedGIFNamed:@"jhLoading"];
...
//    [HUD setColor:[UIColor colorWithHexString:@"#333333"]];
    ...
    UIImage *image = [self sd_animatedGIFNamed:imageName];

...
@end
@interface LLSchoolModel : HXBaseJSONModel
...
@end
@interface LLSchoolListModel : HXBaseJSONModel
...
@interface LLUniYearListModel : HXBaseJSONModel
@property(nonatomic) NSArray <LLSchoolModel,Optional>* data;
@end
...
@interface UCUCityItemsModel : HXBaseJSONModel
...
@interface UCUCityBaseListMdoel : HXBaseJSONModel

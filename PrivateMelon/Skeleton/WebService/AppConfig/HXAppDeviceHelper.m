...
+ (NSString *)uniqueDeviceIdentifier{
    NSString * identifier = [SAMKeychain passwordForService:[HXAppConfig sharedInstance].appName account:@"uniqueDeviceIdentifier"];
    if(identifier) {
        return identifier;
    }else {
        identifier = [NSString stringWithFormat:@"o%@", [[[UIDevice currentDevice] identifierForVendor] UUIDString]];
        [SAMKeychain setPassword:identifier forService:[HXAppConfig sharedInstance].appName account:@"uniqueDeviceIdentifier"];
